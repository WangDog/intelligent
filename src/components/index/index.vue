            ...
            <div class="answer-panel-init">
                <transition name="question-answer" mode="out-in">
                    ...
                    <div v-if="step == 2" key="step2">
                        <func :limit="questionAndAnswerList[step-1].answerLimit" :questionAndAnswerFunc.sync="questionAndAnswerFunc"></func>
                    </div>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.questionAndAnswerFunc = this.questionAndAnswerList[1];
        },
        components: {
            questionPanel,
            role,
        ...
        watch: {
            ...
            questionAndAnswerFunc: function() {
                console.log("questionAndAnswerFunc ==> " + this.questionAndAnswerFunc);
            }
        },
        activated() {
            toShare();
