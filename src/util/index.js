...
// 返回顶部
export function goTop(position, offset) {
    var timer;
    var positionTmp = position || 0;
    ...
    return (function() {
        ...
        timer = requestAnimationFrame(function fn(){
            ...
            if(oTop > (position||0)){
                document.body.scrollTop = document.documentElement.scrollTop = oTop - (offset || 50);
...
export function toShare() {
    ...
    var content = '买手机，上京东！业务文案描述，业务文案描述，业务文案描述，业务文案描述！';
